...
public static class PARAMETRI
{
    ...
    public static class QUEUE
    {
        ...
        public static class EXCHANGE
        {
            ...
            private const string ROOT_DLE = ROOT + ".dle";
        ...
        public static class PROPRIETA
        {
            ...
            {
                public static string NAME = "ordini.processor.queue";
                //Dead Letter Queue  (messaggi falliti)
                public static string NAME_DLQ = NAME + ".dle";
            }
            public static class INVENTARIO
            {
                public static string NAME = "inventario.processor.queue";
                //Dead Letter Queue  (messaggi falliti)
                public static string NAME_DLQ = NAME + ".dle";
            }
            ...
            {
                public static string NAME = "pagamenti.processor.queue";
                //Dead Letter Queue  (messaggi falliti)
                public static string NAME_DLQ = NAME + ".dle";
            }
        ...
        public static class KEY_ROUTING_EVENTO
        {
            /// <summary>
